...
@section('content')
    ...
    <div class="form-group">
        ...
        {{Form::number('price', '', ['class' => 'form-control', 'placeholder' => 'Project Price'])}}
    </div>
    @if($errors->has('price'))
        <div class="alert alert-danger">
            {{$errors->first('price')}}
    ...
    <div class="form-group">
        ...
        {{Form::textarea('done_jobs', '', ['class' => 'form-control', 'placeholder' => 'Project\'s Done Jobs'])}}
    </div>
    ...
    <div class="form-group">
        ...
        {{Form::date('start_time', '', ['class' => 'form-control', 'placeholder' => 'Project\'s Start Date'])}}
    </div>
    ...
    <div class="form-group">
        ...
        {{Form::date('end_time', '', ['class' => 'form-control', 'placeholder' => 'Project\'s End Date'])}}
    </div>
