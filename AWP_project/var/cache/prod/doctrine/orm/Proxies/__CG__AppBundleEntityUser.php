...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function validateUsername(\Symfony\Component\Validator\Context\ExecutionContextInterface $context)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'validateUsername', [$context]);

        return parent::validateUsername($context);
    }

    /**
     * {@inheritDoc}
     */
    public function validateEmail(\Symfony\Component\Validator\Context\ExecutionContextInterface $context)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'validateEmail', [$context]);

        return parent::validateEmail($context);
    }
