...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\InvoiceType' => function () {
...
}, 'AppBundle\\Form\\Invoice_ProductType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\Invoice_ProductType']) ? $this->services['AppBundle\Form\Invoice_ProductType'] : ($this->services['AppBundle\Form\Invoice_ProductType'] = new \AppBundle\Form\Invoice_ProductType())) && false ?: '_'};
