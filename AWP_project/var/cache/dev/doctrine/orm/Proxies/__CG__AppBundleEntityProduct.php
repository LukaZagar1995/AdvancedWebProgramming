...
class Product extends \AppBundle\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Product' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Product' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Product' . "\0" . 'serialNumber', '' . "\0" . 'AppBundle\\Entity\\Product' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Product' . "\0" . 'price', 'invoices', 'stock'];
        }
